const MainTitle = () => {
  return (
    <main className="relative overflow-hidden min-h-screen bg-azulescuro text-white flex flex-col items-center justify-center pt-32 pb-20">
      ...
      <div className="relative container max-w-[1240px] w-full px-6 mx-auto grid md:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
        ...
        <div className="text-center md:text-left">
          <div className="flex items-center justify-center md:justify-start gap-3 mb-6">
            <span className="inline-flex items-center bg-laranja text-azulescuro2 font-subtitulo font-bold text-sm px-5 py-2 rounded-full shadow-soft">
              BXCOMP 2026
            </span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
            <a
              href="/Regulamento"
              className="bg-laranja text-azulescuro2 font-subtitulo font-bold py-4 px-9 rounded-full transition-transform duration-300 hover:-translate-y-1 hover:shadow-soft text-center"
            >
              REGULAMENTO
            </a>
            <a
              href="/Sobre"
              className="border-2 border-branco text-branco font-subtitulo font-bold py-4 px-9 rounded-full transition-all duration-300 hover:bg-white/10 text-center"
            >
              SAIBA MAIS
            </a>
          </div>
        ...
        <div className="relative flex items-center justify-center min-h-[340px] md:min-h-[420px] order-first md:order-last">
          ...
          <span className="absolute bottom-[6%] right-[2%] z-10 bg-laranja text-azulescuro2 font-subtitulo font-bold text-xs px-4 py-2 rounded-full shadow-soft">
            Calouros SI · EACH-USP
          </span>

          <div className="w-[78%] max-w-[360px] aspect-square rounded-full flex items-center justify-center shadow-soft [background:linear-gradient(160deg,var(--azulciano)_0%,var(--azulescuro2)_75%)]">
