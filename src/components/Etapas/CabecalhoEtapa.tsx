...
const CabecalhoEtapa: React.FC<CabecalhoEtapaProps> = ({ etapas, idSelecionado }) => {
    ...
    return (
        <div id="Cabecalho" className="block max-w-[52vw] [@media(max-width:768px)]:max-w-full">
            ...
            <p className="inline-block text-branco text-[1.02rem] font-roboto leading-relaxed">
                {etapa.descricao}
            </p>
            {!etapa.estaLiberada && (
                <p className="mt-4 inline-flex items-center gap-2 font-subtitulo text-sm text-branco/80">
