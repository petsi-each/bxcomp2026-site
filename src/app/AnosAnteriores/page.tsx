    ...
    return (
        <div className="page">
            ...
            <main className="min-h-screen flex items-center justify-center px-6 pt-24 pb-16">
                <div className="max-w-[560px] text-center bg-gradient-to-br from-verdescuro2 to-verdescuro rounded-card p-12 shadow-soft">
                    <span className="inline-flex items-center bg-laranja text-verdescuro2 font-subtitulo font-bold text-xs px-4 py-2 rounded-full mb-6">
                        EM CONSTRUÇÃO
                    </span>
                    <h1 className="font-eloquent font-black text-3xl text-creme mb-4">Anos anteriores</h1>
                    <p className="font-roboto text-bege/85 leading-relaxed">
